...
Client uses their internal team to follow Notion checklists. Brand Alchemy provides QA check-ins at defined phase gates. No additional cost.
...
## 09 — Tooling & Infrastructure

| Tool | Purpose | Cost |
|---|---|---|
| Tally | Intake form at `/studio/intake` | Free tier |
