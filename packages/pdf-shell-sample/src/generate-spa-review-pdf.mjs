...
const outFile = join(outDir, 'spa-review-replies.pdf')
...
const content = {
  title: 'Copy & Paste Review Replies: Spa',
  goal:
    'Goal: Respond to 3 reviews this month, target recent reviews and aim to respond within 72h',
  positive: {
    header: 'Positive Review',
    template:
      'Thanks so much, [Name]! We’re thrilled you loved your [service]. Can’t wait to welcome you back for your next appointment!',
    example:
      '“Thanks so much, Mika! We’re thrilled you loved your balayage. Can’t wait to welcome you back for your next appointment!”',
    addOn:
      'P.S. Next time, ask about our [signature treatment], clients love it!',
  },
  mixed: {
    header: 'Mixed Review',
    template:
    ...
    example:
      '“Appreciate your feedback, Alex. Glad you enjoyed the manicure. We’re working on reducing wait times and your note helps us improve. Hope to see you again soon.”',
  },
  poor: {
    header: 'Poor Review',
    template:
    ...
    privateTemplate:
      'Thanks for reaching out, [Name]. I’d like to make this right. Can you share the appointment date and service so I can investigate? I’ll follow up with a solution.',
    disclaimer:
  ...
  return h(
    ...
    h(
      ...
      h(SectionBlock, {
        ...
        addOnText: content.positive.addOn,
      }),
      h(SectionBlock, {
...
registerBrandPdfFonts()
const buf = await renderToBuffer(h(SpaReviewDoc))
