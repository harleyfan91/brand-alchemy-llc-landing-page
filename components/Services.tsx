...
const solutions = [
  {
    ...
    description:
      "Begin with your Identity Kit. It gives you a clear voice, a clear look, and practical next steps, so you are not guessing every time you write a post, update your site, or hand something to a contractor.",
    icon: (
  ...
  {
    title: "Choose what helps next",
    description:
      "Then choose the tools that solve the next problem in front of you. Use them when you need help knowing what to say, what to post, what to fix first, or how to show up more clearly without turning marketing into a full-time job.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description:
      "Keep the brand consistent as you go. Use your guides, templates, and tools to make your photos, posts, and customer touchpoints feel clear, polished, and connected instead of pieced together week by week.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
