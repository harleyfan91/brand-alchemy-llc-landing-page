...
const solutions = [
  ...
  {
    title: "Profile & SEO Tools",
    description: "Your Google and Yelp profiles are often the first thing a customer sees. Our kits walk you through optimizing them step by step, with templates you can use right away.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: "Templates, guides, and checklists that replace the need for a consultant. Pick what you need, follow the steps, and see results — no marketing experience required.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
    ...
    <section id="services" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-20">
          ...
          <h3 className="text-4xl md:text-5xl font-serif text-gray-900 text-center">Do it yourself. Do it right.</h3>
        </div>
