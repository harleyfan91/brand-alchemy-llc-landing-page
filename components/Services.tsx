...
const solutions = [
  {
    ...
    description:
      "Start with the Identity Kit to define how your business sounds and looks, so everything else has a clear starting point instead of feeling pieced together.",
    icon: (
  ...
  {
    title: "Marketing tools & kits",
    description:
      "Choose from a growing catalog of kits, guides, and templates to help with content, profiles, reviews, messaging, and the marketing tasks that matter most to your business.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description:
      "Use the system to show up more clearly, promote your business with more confidence, and turn stronger branding and marketing into real momentum over time.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="ba-section-stack--default mb-6 text-center md:mb-16">
          ...
          <h3 className="ba-section-display-title font-serif font-normal text-4xl text-gray-900 md:text-5xl">Start with the brand. Build from there.</h3>
        </div>
      </div>
