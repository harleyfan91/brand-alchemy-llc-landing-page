...
const solutions = [
  {
    ...
    description:
      "Start with a clear visual identity and voice. Our guides help you set consistent standards for how your business looks and communicates, so every touchpoint feels intentional. You can do it without a design team or a big budget.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Turn that foundation into action with plain steps and real templates. Pick the kit that fits your situation, follow along, and keep moving without marketing experience. Built for people who are doing it themselves.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    title: "Get Found",
    description:
      "When someone looks for what you offer, your online profiles are often the first impression. Our kits walk you through setup and visibility so the right people can find you, understand what you do, and reach out with confidence.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-6 h-6">
