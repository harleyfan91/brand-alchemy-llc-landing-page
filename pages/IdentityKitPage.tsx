    ...
    <main className="flex-grow scroll-mt-20 bg-white pt-24 pb-16 md:pt-28 md:pb-24">
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-xs font-medium uppercase tracking-[0.2em] text-gray-400">
            <li>
      ...
      <div className="mx-auto mt-12 max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex justify-center">
          <a
            ...
            className="inline-flex w-full max-w-md items-center justify-center rounded-full bg-black px-8 py-3.5 text-xs font-bold uppercase tracking-widest text-white transition-colors hover:bg-gray-800 sm:w-auto"
          >
